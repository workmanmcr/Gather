...
namespace Gather.Migrations
{
    public partial class Initialmigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "GatheringActivities",
                columns: table => new
                {
                    GatheringActivityId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    GatheringId = table.Column<int>(type: "int", nullable: false),
                    ActivityId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_GatheringActivities", x => x.GatheringActivityId);
                    table.ForeignKey(
                        name: "FK_GatheringActivities_Activities_ActivityId",
                        column: x => x.ActivityId,
                        principalTable: "Activities",
                        principalColumn: "ActivityId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_GatheringActivities_Gatherings_GatheringId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    GatheringUserId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    GatheringId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GatheringUsers", x => x.GatheringUserId);
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_GatheringUsers_Gatherings_GatheringId",
                        column: x => x.GatheringId,
                        principalTable: "Gatherings",
                        principalColumn: "GatheringId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_GatheringItems_Items_ItemId",
                        column: x => x.ItemId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_GuestItems_Items_ItemId",
                        column: x => x.ItemId,
                        principalTable: "Items",
                        principalColumn: "ItemId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                name: "GatheringVendors",
                columns: table => new
                {
                    GatheringVendorId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    GatheringId = table.Column<int>(type: "int", nullable: false),
                    VendorId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_GatheringVendors", x => x.GatheringVendorId);
                    table.ForeignKey(
                        name: "FK_GatheringVendors_Gatherings_GatheringId",
                        column: x => x.GatheringId,
                        principalTable: "Gatherings",
                        principalColumn: "GatheringId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_GatheringVendors_Vendors_VendorId",
                        column: x => x.VendorId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    UserVendorId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    VendorId = table.Column<int>(type: "int", nullable: false),
                    UserId = table.Column<string>(type: "varchar(255)", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserVendors", x => x.UserVendorId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GatheringActivities_ActivityId",
                table: "GatheringActivities",
                column: "ActivityId");

            migrationBuilder.CreateIndex(
                name: "IX_GatheringActivities_GatheringId",
                table: "GatheringActivities",
                column: "GatheringId");

            migrationBuilder.CreateIndex(
                name: "IX_GatheringItems_GatheringId",
                table: "GatheringItems",
                column: "GatheringId");

            migrationBuilder.CreateIndex(
                name: "IX_GatheringItems_ItemId",
                table: "GatheringItems",
                column: "ItemId");

            migrationBuilder.CreateIndex(
                name: "IX_GatheringUsers_GatheringId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GatheringVendors_GatheringId",
                table: "GatheringVendors",
                column: "GatheringId");

            migrationBuilder.CreateIndex(
                name: "IX_GatheringVendors_VendorId",
                table: "GatheringVendors",
                column: "VendorId");

            migrationBuilder.CreateIndex(
                name: "IX_GuestItems_ItemId",
                table: "GuestItems",
                column: "ItemId");
